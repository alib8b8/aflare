...
func TestSpecValidate_OK(t *testing.T) {
	cases := []Spec{
		...
		{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com"},
		{Name: "api-with-path", Type: TypeHTTP, BaseURL: "https://api.example.com/v1"},
		{Name: "api-bearer", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBearer,
			Credential: &CredentialRef{Kind: CredentialKindSecret, Group: "connectors", Key: "api-token"}},
		{Name: "api-basic", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBasic, Username: "user",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "API_PASS"}},
		{Name: "api-header", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeHeader, AuthHeader: "X-API-Key",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "API_KEY"}},
		{Name: "api-writable", Type: TypeHTTP, BaseURL: "https://api.example.com", ReadOnly: boolPtr(false)},
		{Name: "api-timeout", Type: TypeHTTP, BaseURL: "https://api.example.com", TimeoutSec: 10},
	}
...
func TestSpecValidate_Errors(t *testing.T) {
	cases := []struct {
		...
		{"http missing base_url", Spec{Name: "api", Type: TypeHTTP}, "base_url is required"},
		{"http relative base_url", Spec{Name: "api", Type: TypeHTTP, BaseURL: "api.example.com/v1"}, "absolute http(s) URL"},
		{"http ftp scheme", Spec{Name: "api", Type: TypeHTTP, BaseURL: "ftp://api.example.com"}, "scheme must be http or https"},
		{"http userinfo in base_url", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://user:pass@api.example.com"}, "userinfo"},
		{"http query in base_url", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com?x=1"}, "query or fragment"},
		{"http fragment in base_url", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com#frag"}, "query or fragment"},
		{"http host rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", Host: "h"}, "use base_url"},
		{"http database rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", Database: "db"}, "use base_url"},
		{"http max_rows rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", MaxRows: 10}, "max_rows is not valid"},
		{"http root rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", Root: "/data"}, "root is not valid"},
		{"http include rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", Include: []string{"*.md"}}, "include is not valid"},
		{"http max_bytes rejected", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", MaxBytes: 10}, "max_bytes is not valid"},
		{"http credential without auth", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "credential requires auth_type"},
		{"http auth_header without auth", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthHeader: "X-API-Key"}, "auth_header requires auth_type=header"},
		{"http username without auth", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", Username: "u"}, "username is only valid"},
		{"http bearer missing credential", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBearer}, "requires a credential"},
		{"http bearer with username", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBearer, Username: "u",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "username/auth_header are not valid"},
		{"http basic missing credential", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBasic, Username: "u"}, "requires a credential"},
		{"http basic missing username", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeBasic,
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "requires a username"},
		{"http header missing auth_header", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeHeader,
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "auth_header is required"},
		{"http header bad header name", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeHeader, AuthHeader: "X API Key",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "only letters, digits and hyphens"},
		{"http header forbidden Host", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: AuthTypeHeader, AuthHeader: "Host",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "may not be set"},
		{"http unknown auth_type", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com", AuthType: "digest",
			Credential: &CredentialRef{Kind: CredentialKindEnv, Key: "K"}}, "unknown auth_type"},
		{"null byte in base_url", Spec{Name: "api", Type: TypeHTTP, BaseURL: "https://api.example.com/\x00"}, "null byte"},
	}
	for _, c := range cases {
		err := c.spec.Validate()
		if err == nil {
