...
func PrintServeUsage() {
	...
	fmt.Println("  --capabilities, -c <caps>      - Comma-separated capabilities (e.g. reflection,memory)")
	fmt.Println("  --help, -h                     - Show this help")
	fmt.Println("\nAvailable capabilities: reflection, human-in-loop, utility, memory, planning, workflow")
	fmt.Println("\nExamples:")
