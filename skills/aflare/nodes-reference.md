...
Quick reference for the most common built-in nodes (a curated subset — run `aflare list` for the full catalog, and see the generated `docs/nodes-reference.md` in the repository for complete parameter schemas).
